...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate{
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        ZDCChat.initialize(withAccountKey: "65OtHqlB8iIlBuqD3A6dsMlbfAhDTMSZ")
        //
        //
        Zendesk.initialize(appId: "1d9e65ef555180159744b2dc1c6719bfe9c418b0267541b9",
                           clientId: "mobile_sdk_client_b3e199f185f952237808",
                           zendeskUrl: "https://cseseniordesign.zendesk.com")
        //
        //
        ...
        // #####  PUSH NOTIFICATION  ####
        // Request user authorization for local/push notification
